...
export async function getUsageForProvider(connection, proxyOptions = null) {
  const { id, provider, accessToken, apiKey, providerSpecificData, projectId, idToken } = connection;
  ...
  return await handler({ connectionId: id, provider, accessToken, apiKey, providerSpecificData, providerDataWithProjectId, proxyOptions, idToken });
}
